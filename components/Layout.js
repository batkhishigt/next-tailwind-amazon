    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Ecmmerce wibsite" />
                            ...
                            <Link href="/cart">
                                <a className='p-2'>
                                    Cart {cartItemsCount > 0 && (
                                        <span className='ml-1 rounded-full bg-red-600 px-2 py-1 texr-xs font-bold text-white'>
                                            {cartItemsCount}
                                        </span>
                                    )}
                                </a>
